<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教学标题" prop="jiaoxuebiaoti">
          <el-input v-model="ruleForm.jiaoxuebiaoti" 
              placeholder="教学标题" clearable  :readonly="ro.jiaoxuebiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教学标题" prop="jiaoxuebiaoti">
              <el-input v-model="ruleForm.jiaoxuebiaoti" 
                placeholder="教学标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
...
export default {
                	        ...
                	        jiaoxuebiaoti: '',
	                        	        ...
	                        	        fabushijian: '',
	                        	                        	                        	        clicktime: '',
                                                                                                                                          ...
                                                                                                                                          rules: {
                  jiaoxuebiaoti: [
                            { required: true, message: '教学标题不能为空', trigger: 'blur' },
                                    	                                                              ],
                  tupianfengmian: [
                                    	                                                              ],
                  jiaoxueshipin: [
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `shipinxuexi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shipinxuexiCrossAddOrUpdateFlag = false;
                  this.parent.search();
