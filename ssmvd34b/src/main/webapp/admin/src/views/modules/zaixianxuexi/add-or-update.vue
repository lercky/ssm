<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教学名称" prop="jiaoxuemingcheng">
          <el-input v-model="ruleForm.jiaoxuemingcheng" 
              placeholder="教学名称" clearable  :readonly="ro.jiaoxuemingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教学名称" prop="jiaoxuemingcheng">
              <el-input v-model="ruleForm.jiaoxuemingcheng" 
                placeholder="教学名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="教学视频" prop="jiaoxueshipin">
          <file-upload
          tip="点击上传教学视频"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.jiaoxueshipin" label="教学视频" prop="jiaoxueshipin">
            <el-button type="text" size="small" @click="download(ruleForm.jiaoxueshipin)">预览</el-button>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="教学文档" prop="jiaoxuewendang">
          <file-upload
          tip="点击上传教学文档"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.jiaoxuewendang?ruleForm.jiaoxuewendang:''"
          @change="jiaoxuewendangUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.jiaoxuewendang" label="教学文档" prop="jiaoxuewendang">
            <el-button type="text" size="small" @click="download(ruleForm.jiaoxuewendang)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
                                                                  <el-col :span="12">
          ...
          <el-form-item class="input" v-if="ruleForm.fabushijian" label="发布时间" prop="fabushijian">
              <el-input v-model="ruleForm.fabushijian" 
                placeholder="发布时间" readonly></el-input>
                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                  <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="教学内容" prop="jiaoxueneirong">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.jiaoxueneirong" label="教学内容" prop="jiaoxueneirong">
                    <span v-html="ruleForm.jiaoxueneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    back() {
      ...
      this.parent.contentStyleChange();
				...
				this.addEditUploadStyleChange()
                                ...
                                jiaoxuewendangUploadChange(fileUrls) {
                this.ruleForm.jiaoxuewendang = fileUrls;
				this.addEditUploadStyleChange()
            },
                                                                                    	addEditStyleChange() {
	  this.$nextTick(()=>{
