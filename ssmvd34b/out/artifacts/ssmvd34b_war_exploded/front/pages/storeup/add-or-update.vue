<template>
	<view class="content">
		<form>
				...
				<view class="title">表名</view>
				<input v-model="ruleForm.tablename" placeholder="表名"></input>
			</view>
												<view class="cu-form-group">
				<view class="title">收藏名称</view>
				<input v-model="ruleForm.name" placeholder="收藏名称"></input>
			</view>
												<view class="cu-form-group" @tap="pictureTap">
				<view class="title">收藏图片</view>
				<view class="right-input">
					<image class="avator" v-if="ruleForm.picture" :src="ruleForm.picture" mode="widthFix"></image>
