          ...
          <el-form-item class="input" label="课程名称" prop="kechengmingcheng">
              <el-input v-model="ruleForm.kechengmingcheng" 
                placeholder="课程名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="名师姓名" prop="mingshixingming">
          <el-input v-model="ruleForm.mingshixingming" 
              placeholder="名师姓名" clearable  :readonly="ro.mingshixingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="名师姓名" prop="mingshixingming">
              <el-input v-model="ruleForm.mingshixingming" 
                placeholder="名师姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教龄" prop="jiaoling">
          <el-input v-model="ruleForm.jiaoling" 
              placeholder="教龄" clearable  :readonly="ro.jiaoling"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教龄" prop="jiaoling">
              <el-input v-model="ruleForm.jiaoling" 
                placeholder="教龄" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
          ...
          <el-form-item class="input" label="课程类型" prop="kechengleixing">
              <el-input v-model="ruleForm.kechengleixing" 
                placeholder="课程类型" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="适合专业" prop="shihezhuanye">
          <el-input v-model="ruleForm.shihezhuanye" 
              placeholder="适合专业" clearable  :readonly="ro.shihezhuanye"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="适合专业" prop="shihezhuanye">
              <el-input v-model="ruleForm.shihezhuanye" 
                placeholder="适合专业" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `mingshituijian/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.mingshituijianCrossAddOrUpdateFlag = false;
                  this.parent.search();
